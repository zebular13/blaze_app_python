...
#    default_detector_model='models/face_detection_short_range_pixabay1675_unsigned_uint8quant.tflite'
#    default_landmark_model='models/face_landmark_pixabay1941_unsigned_uint8quant.tflite'
   default_detector_model='models/face_detection_short_range_pixabay1675_unsigned_uint8quant_vela.tflite'
   default_landmark_model='models/face_landmark_pixabay1941_unsigned_uint8quant_vela.tflite'
  ...
  ## Pixabay quantized
#    default_detector_model = "models/pose_detection_pixabay_uint8_quant.tflite"
#    default_landmark_model = "models/pose_landmark_full_pixabay_uint8_quant.tflite" 
...
#    default_landmark_model = "models/pose_landmark_full_quant.tflite" 
   default_detector_model = "models/lite_pose_detection_128x128_full_integer_quant.tflite" 
   default_landmark_model = "models/lite_pose_landmark_39kp_256x256_full_integer_quant.tflite" 
#    default_detector_model = "models/pose_detection_128x128_full_integer_quant.tflite" 
#    default_landmark_model = "models/pose_landmark_upper_body_256x256_full_integer_quant.tflite" # blazebase.py:471: RuntimeWarning: invalid value encountered in divide return inter / union  # [A,B]
#    default_detector_model = "models/pose_detection_128x128_full_integer_quant_vela.tflite" #Node number 1 (EthosuDelegate) failed to invoke.
...
blaze_landmark = BlazeLandmark(blaze_landmark_type, delegate_path=DELEGATE_PATH)
# else:
