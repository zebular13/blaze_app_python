...
ap.add_argument('-w', '--withoutview', default=True, action='store_true', help="Disable Output viewing. Default is on")
...
ap.add_argument('-f', '--fps'        , default=True, action='store_true', help="Enable FPS display. Default is off")
